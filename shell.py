...
def init_db():
    ...
    with app.app_context():
        if not os.path.exists(app.config['SQLALCHEMY_DATABASE_URI']):
            ...
            t_4 = Tft('00.00.00004', 'FX000000004', '200', '1200:1', '10mpx', False, 35.0, 45.0, 33.0, 39.0, 5.0, 70.0, False, False, ts_1.id, tr_4.id, tp_4.id)
            t_5 = Tft('00.00.00005', 'FX000000005', '400', '1000:1', '10mpx', True, 35.0, 45.0, 33.0, 39.0, 5.0, 70.0, False, True, ts_3.id, tr_5.id, tp_5.id)
